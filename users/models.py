...
class DriverProfile(models.Model):
    ...
    user = models.OneToOneField(Users, on_delete=models.CASCADE, related_name='driver_profile', default="")
    license_number = models.CharField(max_length=20, unique=True, default="")
    vehicle_type = models.CharField(max_length=50, choices=VEHICLE_CHOICE, default="")
